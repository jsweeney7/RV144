...
We would expect two graphs of equal size (50% on either side) if the two variables are independent. They do not appear equal... shedding doubt of independence. 
...
We now want to run a statsical test 
```{r}
